export const ru = {
  ...
  run: {
    title: "Бег",
    subtitle: "Шагомер работает, пока экран включён",
    ...
    kcal: "ккал",
    time: "Время",
    stepsHint: "Телефон — в карман или в руку: шаги считает акселерометр",
    noMotion: "Датчики движения недоступны — посчитаем только время и калории",
    motionDenied: "Доступ к датчикам запрещён. Пробежка запишется без шагов.",
    keepScreenOn: "Не блокируйте экран во время пробежки",
    tooShort: "Пробежка короче 30 секунд не сохраняется",
    saved: "Пробежка сохранена! +5 XP 🏃",
    saveFailed: "Не удалось сохранить пробежку",
    discard: "Сбросить",
  },
